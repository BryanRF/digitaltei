...
class ProductController extends Controller
{
    ...
    public function edit(Product $product)
    {
        ...
        $empresa = $this->nameEmpresa();
        return view('product.edit',compact('product','brands','categories','subcategories','titulo','empresa'));
    }
    public function create()
    {
        ...
        $empresa = $this->nameEmpresa();
        return view('product.create',compact('brands','categories','subcategories','titulo','empresa'));
    }
